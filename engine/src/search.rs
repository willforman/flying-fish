...
fn find_move_helper(position: &Position, evaluate_position: &impl EvaluatePosition, generate_moves: &impl GenerateAllMoves, curr_depth: u32, max_depth: u32) -> (Move, f64) {
